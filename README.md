...
### Misc
My solution to *The Blocks Problem* (and possibly one other) used a stack implementation that wasn't generic and which I later ripped out in favor of a generic one.
